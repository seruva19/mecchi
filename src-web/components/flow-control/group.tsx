...
// const MecchiGroupNodeInfo = {
//   type: 'group',
//   group: 'control',
//   view: MecchiGroupNode,
//   data: {
...
// export default MecchiGroupNodeInfo;

// const selector = (id: string) => (store: MecchiNodeStore) => ({
//   setParams: (key: string, value: any) => store.updateNode(id, { [key]: value }),
// });

// export function MecchiGroupNode({ id, data }: { id: string, data: typeof MecchiGroupNodeInfo.data }) {
